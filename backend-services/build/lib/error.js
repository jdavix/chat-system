...
exports.rescueController = exports.handleError = exports["default"] = void 0;
...
var rescueController = function rescueController(fn) {
  return function (req, res, next) {
    return Promise.resolve(fn(req, res, next))["catch"](function (e) {
      console.log(e);
      var error = e;
