  ...
  return (
      <div className="sidebar">
        <div className="groups-container">
          <div className="group-title"><h2>Groups</h2><Button color="secondary" size="sm">New Group</Button></div>
        ...
        <div className="people-container">
          <div className="group-title"><h2>Direct Messages</h2><Button color="secondary" size="sm">New Direct Message</Button></div>
